...
import effectVertexShader from "../Shaders/CarEffect_bloom/vertex.glsl";
import effectFragmentShader from "../Shaders/CarEffect_bloom/fragment.glsl";
import Time from "../Utils/Time.js";

export default class CarEffect_bloom {
  constructor() {
    this.site = new Site();
    ...
    // Resource
    this.resource = this.resources.items.carEffect2;
  ...
  setModel() {
    ...
    this.model.children[0].layers.set(1);
